          ...
          {projects.map((project, index) => (
            ...
            >
              {project.url.startsWith("/") ? (
                ...
                // 외부 사이트인 경우 (ohihoo, checkon, pium)
                <a
                  href={project.url}
                  target="_blank"
