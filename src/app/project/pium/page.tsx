      ...
      <div className="container mx-auto px-4  text-center">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mb-6">
            ...
            />
            <h2 className="text-xl font-bold mb-1">식물 쇼핑몰 및 커뮤니티</h2>
          ...
          <div className="mt-8 text-left max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="bg-[#2c2635] bg-opacity-90 p-3 rounded-lg">
                <div className="text-base font-semibold mb-1">식물 쇼핑</div>
              ...
              <div className="bg-[#2c2635] bg-opacity-90 p-3 rounded-lg">
                <div className="text-base font-semibold mb-1">식물 공구</div>
                <p className="text-gray-300 text-xs">
