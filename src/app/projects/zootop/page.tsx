        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mb-16">
            ...
            >
              ...
              />
              <div className="absolute -inset-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg blur opacity-30" />
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              className="border-t border-indigo-400/30 pt-12"
            >
              <h2 className="text-xl sm:text-2xl font-heading text-white mb-8 text-center">
                지원
              </h2>
              <div className="glass-card p-8 rounded-lg border border-indigo-400/30">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-heading text-indigo-300 mb-2">
                      프로젝트 문의
                    </h3>
                    <p className="text-indigo-100 text-sm sm:text-base font-body mb-4 leading-relaxed">
                      동물원 관리 시스템 도입이나 맞춤형 개발 관련 문의사항이
                      있으시면 언제든지 연락 주세요.
                    </p>
                    <a
                      href="mailto:thinkingcatworks@gmail.com"
                      className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-200 text-sm font-heading"
                    >
                      이메일 보내기
                    </a>
                  </div>
