    ...
    <section id="projects" className="py-24 bg-black">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Link href="/projects/ohihoo" className="block">
            <motion.div
              ...
              <div className='mt-4 flex items-center justify-center gap-2'>
                <div className='items-center rounded-full flex justify-center text-center h-6 w-20 px-1 neon-text border border-0.5'>오히후</div> 
                <div>X</div>
